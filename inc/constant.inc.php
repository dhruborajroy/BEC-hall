...
define('FRONT_SITE_PATH','http://127.0.0.1/admission/');
define('STORE_ID',"dhrub5f103f94cd3e4");
define('STORE_PASSWORD',"dhrub5f103f94cd3e4@ssl");
define('STUDENT_IMAGE',FRONT_SITE_PATH."/media/applicants/");
define('UPLOAD_STUDENT_IMAGE',$_SERVER['DOCUMENT_ROOT']."/admission/media/applicants/");
define('SITE_DISH_IMAGE',FRONT_SITE_PATH."media/");
